...
public class ActivityZakatPeternakan extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String[] values=new String[] {"Zakat Fitrah","Zakat Profesi","Zakat Fidyah","Zakat Emas dan Perak","Zakat Pertanian","Zakat Peternakan","Zakat Rikaz"};
		...
		lvDzikir.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View view, int position,
                ...
                switch(position){
                	case 0:
                		intent=new Intent(ActivityZakatPeternakan.this, Istigfar.class);
                		startActivity(intent);
                	break;
                	case 1:
                		intent=new Intent(ActivityZakatPeternakan.this, Tahmid.class);
                		startActivity(intent);
                	break;
                	case 2:
                		intent=new Intent(ActivityZakatPeternakan.this, Tasbih.class);
                		startActivity(intent);
                	break;
                	case 3:
                		intent=new Intent(ActivityZakatPeternakan.this, Takbir.class);
                		startActivity(intent);
                	case 4:
                		intent=new Intent(ActivityZakatPeternakan.this, Tahlil.class);
                		startActivity(intent);
                	break;
	...
	public boolean onOptionsItemSelected(MenuItem item) {
	  String id_surah= getIntent().getStringExtra("id");  
  	  switch (item.getItemId()) {
  	    	...
  	    	Intent intentHome= new Intent(ActivityZakatPeternakan.this,Main.class);
